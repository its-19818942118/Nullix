...
# # #
  ...
  ###> Core Packages Start
   ## MikaNix Dependencies/Essentials
    networkmanagerapplet tlrc networkmanager
    yad dolphin swww btop jp2a rofi-wayland
    waybar dunst wl-clipboard wlogout nwg-look
    ark envsubst sox cliphist swaylock
    swaylock-effects swaylock-fancy
    helvum ani-cli home-manager #mpris-notifier
